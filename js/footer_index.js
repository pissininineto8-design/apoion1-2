...
"<footer>"+
  ...
  "<div id='division_1' style='background-color:rgb(37, 37, 39)'>"+
       "<table id='tb_rodape'>"+
         ...
         "<tr><td> </td></tr>"+
         "<tr><td style='color:WHITE; border: none;'> <b style='font-family: Courier New, monospace;'><a id='a_contatos_footer' href='Paginas/ramais.html'>Página de Contatos</a> </td></tr>" +
    ...
    "<div class='container'><p id='scroll_links'></p>"+
           "<ul class='links'>"+
            ...
            "<ul class='links'>"+
                ...
                "<li><a href='https://www.trt9.jus.br/institucional/juizTitular.xhtml' target='_blank'> <button id='botao_links'>Ju&iacute;zes Titulares</button></a><!-- Consulta de Lotações --></li>"+
...
"</ul>"+ 
    ...
    "<li><a href='https://microsens.webassist.com.br/index.php' target='_blank'> <button id='botao_links'>Garantia SAMSUNG</button></a><!-- Garantias de Equipamentos --></li>"+  
            ...
            "<ul class='links'>"+
                 ...
                 "Manual do PJe - Oficial de Justiça, Manual do PJe - 1 Grau, Manual do PJe - 2 Grau, , Manual do PJe - Chips, Manual do Malote Digital, https://pje.csjt.jus.br/manual/index.php/Acervo_Digital, https://pje.csjt.jus.br/manual/index.php/AUD_4.0, " +
    ...
    "<ul class='links'>"+
            ...
            "<ul class='links'>"+
                ...
                "<!-- Aprendizagem RW3, Assyst WEB, BrowserStack (Testar link), Chat BOT - CSTI, CSWIKI, Elastic Kibana, Elastic Monitor, Endpoint Central (Zoho), Localize IP (Descobrir Região), Meu IP (Descobrir IP), PJe Consulta Processual, PJe Homologação, Pje Treinamento, Remover MFA VPN, Portal Captive, https://aprendizagem.rw3tecnologia.com/, https://csti.trt9.jus.br/assystweb, Consulta de Drivers Lenovo, " +
