...
"<footer>"+
  "<nav id='menu-h'>"+
      "<ul class='menu-h'>"+
          ...
          "<li class='menu_3'><a id='a_menu_3' href='redirecionamento.html?v=" + versao + "'>Redirecionamento</a></li>"+
      "</ul>"+
  "</nav>"+
    ...
    "<div class='container'><p id='scroll_links'></p>"+
           "<ul class='links'>"+
            ...
            "<ul class='links'>"+
                ...
                "<!-- Agenda Magistrados, COMPOSIÇÃO (Seções), Consulta Assessores, Consulta Diretores, Consulta Peritos, Consulta Magistrados, Consulta Servidores, Juízes Substitutos, Juízes Titulares, Lotações Intranet, Magistrados e Servidores, Magistrados Substitutos, Magistrados Titulares " +
                ...
                "COMPOSIÇAO (Seções), Juizes Substitutos, Juizes Titulares, Lotaçoes Intranet, Força de Trabalho (Organograma), Consulta Cargo de Servidor --></li>"+
                ...
                "<li><a href='https://www.trt9.jus.br/portal/secoes.xhtml?id=5' target='_blank'> <button id='botao_links'>COMPOSI&Ccedil;&Atilde;O (Seções)</button></a><!-- Consulta de Lotações --></li>"+
                ...
                "<li><a href='https://www.trt9.jus.br/portal/paginaDownload.xhtml?id=127' target='_blank'> <button id='botao_links'>Ju&iacute;zes Substitutos</button></a><!-- Consulta de Lotações, Magistrados Substitutos --></li>"+
                "<li><a href='https://www.trt9.jus.br/institucional/juizTitular.xhtml' target='_blank'> <button id='botao_links'>Ju&iacute;zes Titulares</button></a><!-- Consulta de Lotações, Magistrados Titulares --></li>"+
...
"</ul>"+ 
    ...
    "<li><a href='https://microsens.webassist.com.br/index.php' target='_blank'> <button id='botao_links'>Garantia SAMSUNG</button></a><!-- Garantias de Equipamentos --></li>"+  
            ...
            "<ul class='links'>"+
                 ...
                 "Manual do PJe - Oficial de Justiça, Manual do PJe - 1 Grau, Manual do PJe - 2 Grau, , Manual do PJe - Chips Tabelas, Manual do Malote Digital, https://pje.csjt.jus.br/manual/index.php/Acervo_Digital, https://pje.csjt.jus.br/manual/index.php/AUD_4.0, " +
                 ...
                 "<li><a href='../Documentos/md_manual-do-usurio_1.8.6.1.pdf' target='_blank'> <button id='botao_links'>Manual do Malote Digital</button></a><!-- Manuais --></li>" +
    ...
    "<ul class='links'>"+
            ...
            "</ul>"+
                 ...
                 "<!-- DJEN, Falcão, Falcao, GPrec, Malote Digital, PJe Mídias CNJ, PJe Midias CNJ, Portal do SIGEO, PROAD, SIGEO AJ-JT (Consulta de Perito), SIJU, SISCONDJ-TJ, Escritório Digital (CNJ), Escritorio, Galileu " +
                 ...
                 "https://www.trt9.jus.br/siscondjtrtpr/login.jsp, https://escritoriodigital.jus.br/escritoriodigital/login.faces, https://galileu.trt4.jus.br/login --></li>"+
                 ...
                 "<li><a href='https://galileu.trt4.jus.br/login' target='_blank'> <button id='botao_links'>Galileu</button></a><!-- Sistemas Externos, Galileu --></li>" +
            ...
            "<ul class='links'>"+
                ...
                "https://trt9-techcom.treetools.com.br/sb3/pages/inicio.zul, Consulta de Drivers Lenovo, https://www.trt9.jus.br/cswiki/index.php/P%C3%A1gina_principal, https://kibana.trt9.jus.br/s/servicedesk/login?next=%2Fs%2Fservicedesk%2Fapp%2Fhome#/ " +
                ...
                "https://endpointcentral.manageengine.com/webclient#/uems/home/summary, https://nordvpn.com/pt-br/ip-lookup/?srsltid=AfmBOorUn9WOYsrQ_siIgyeHcrE8cZcXB3N7F4ttY03nijAnxWTaBgPa, https://pcsupport.lenovo.com/br/pt/warranty-lookup?cid=br:sem|se|google|b2c-public-amd-notebook-google-pmax-conv-aon||||17923677094|||pmax|mixed|all&gad_source=1&gad_campaignid=19657347733&gbraid=0AAAAADtpWiC-lS8y_dzT6bLOENeArbGwm&gclid=EAIaIQobChMIxNGAsv-ulQMVAFRIAB3qkyKXEAAYASAAEgIcLvD_BwE#/ --> </li>"+
                ...
                "<li><a href='https://pcsupport.lenovo.com/br/pt/warranty-lookup?cid=br:sem|se|google|b2c-public-amd-notebook-google-pmax-conv-aon||||17923677094|||pmax|mixed|all&gad_source=1&gad_campaignid=19657347733&gbraid=0AAAAADtpWiC-lS8y_dzT6bLOENeArbGwm&gclid=EAIaIQobChMIxNGAsv-ulQMVAFRIAB3qkyKXEAAYASAAEgIcLvD_BwE#/' target='_blank'> <button id='botao_links'>Consulta de Drivers Lenovo</button></a><!-- Sistemas Voltados a CSTI --></li>"+
...
"</div>" +
"</div>" +
"<p id='versao'>Vers&atilde;o 0.1.24</p>"+
"</article>"+
"</footer>"
